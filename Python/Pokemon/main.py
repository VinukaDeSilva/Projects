...
class Player(Character):
    ...
    def attack(self, other):
        while True:
            choice = str.lower(input("What move woulf you like to chose:  basic move, special move, heal"))
...
class Opponent(Character):
    ...
    def attack(self, other):
        ...
        if Opponent_choice == "basic move" or Opponent_choice == "special move":
            ...
            other.health -= damage
            print(f"Opponent attack with {Opponent_choice}. He dealt {damage} damage")
